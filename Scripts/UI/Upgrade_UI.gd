...
func _on_buy_1_pressed() -> void:
	...
	if (Game.metal >= 2000 && Game._funds >=15000):
...
func _on_buy_2_pressed() -> void:
	if (Game.oil >= 1000 && Game._funds >=25000 && Game._crystal >= 200):
...
func _on_buy_3_pressed() -> void:
	...
	if (Game.oil >= 10000 && Game._funds >=50000 && Game._metal >= 20000 && Game._crystal >= 250):
